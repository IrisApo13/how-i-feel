...
const BODY_ART = [
  ...
  // The hands are drawn at 0.82 of their first size, scaled about the wrist.
  // At full size a palm was 27 units across against a 16-unit forearm, so the
  // child read as wearing gloves. The hand REGIONS are deliberately left at the
  // old size: they are masked to the silhouette, so the mask trims them back to
  // whatever the drawing occupies, and the unmasked hit area stays generous --
  // which is what a small finger needs.
  f('M55.4,206.7 C51.3,208.4 50.5,213.3 50.5,219 L50.5,227.2 C50.5,231.3 53.8,233.8 58.7,233.8 L66.9,233.8 C71,233.8 72.7,231.3 72.7,227.2 L72.7,216.6 C72.7,210.8 70.2,207.5 66.1,206.7 Z'),
  s('M53.8,229.7 L53.8,241.2', 4.9), s('M59.5,231.3 L59.5,244.4', 4.9), s('M65.3,231.3 L65.3,243.6', 4.9), s('M70.2,229.7 L70.2,239.5', 4.9),
  s('M51.3,214.1 L44.8,222.3', 5.7),
  f('M164.6,206.7 C168.7,208.4 169.5,213.3 169.5,219 L169.5,227.2 C169.5,231.3 166.2,233.8 161.3,233.8 L153.1,233.8 C149,233.8 147.3,231.3 147.3,227.2 L147.3,216.6 C147.3,210.8 149.8,207.5 153.9,206.7 Z'),
  s('M166.2,229.7 L166.2,241.2', 4.9), s('M160.5,231.3 L160.5,244.4', 4.9), s('M154.7,231.3 L154.7,243.6', 4.9), s('M149.8,229.7 L149.8,239.5', 4.9),
  s('M168.7,214.1 L175.2,222.3', 5.7),
...
export const REGIONS = [
  ...
  { id: 'hand-right', view: 'front', label: 'Right hand', group: 'limb', zoomTo: 'hand-right', dot: [61, 223],
    shape: path('M40,204 C50,196 70,196 80,204 C82,222 80,242 74,256 C61,261 48,259 42,252 C38,236 37,218 40,204 Z') },
  { id: 'hand-left', view: 'front', label: 'Left hand', group: 'limb', zoomTo: 'hand-left', dot: [159, 223],
